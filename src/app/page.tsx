        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">Manage your AI blog content</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{stats?.aiTools || 0}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              >
                ...
                <div className="ml-4">
                  <p className="font-medium text-gray-900">Add AI Tool</p>
                  <p className="text-sm text-gray-600">Add a new tool review</p>
                </div>
              </Link>
